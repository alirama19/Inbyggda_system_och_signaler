function [h1,h2,t,u,e] = vm_twostep(a,N,dT,v)
...
% DEL E: starta stegsvarsexperimentet
  ...
  for i=1:N %slinga kommer att köras N-gångar, varje gång tar exakt Ts-sekunder
    ...
    e(i)= bv-h2(i); %räknar ut felvärdet som differens mellan ärvärdet och börvärdet
    
    
    % REGULATORN
if e(i) > 0
	u(i) = 200; %pumpen kan styras med värden mellan 0..255
else
	u(i) =0;
end
...
% DEL F: avsluta experimentet
  ...
  xlabel('samples k')
  ylabel('Nivån i vattentank h1, h2, stegsvar u, felvärde e')
  title('Stegsvar av tvålägesreglering')
  legend('Nivån i tank ett - h1 ', ' Nivån i tank två -h2 ', 'u ', 'e')
