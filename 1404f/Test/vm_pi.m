function [h1,h2,t,u,e] = vm_pi(a,N,dT,v, kp, Ti)
...
% kp: förstärkning k för p reglering
% Ti: integreringstid
% Dt: deriveringstid
...
if e(i) > 0
	...
	u(i) = kp*(e(i)+((dT/Ti)*errorsum)); %pumpen kan styras med värden mellan 0..255
else
    errorsum=0;
	u(i) =0;
end
